...
import com.plcoding.contactscomposemultiplatform.contacts.presentation.screens.ContactListScreen
...
@Composable
fun App(darkTheme: Boolean, dynamicColor: Boolean, appModule: AppModule, imagePicker: ImagePicker) {
